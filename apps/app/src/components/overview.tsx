...
export function Overview() {
    ...
    const rayhfactor =
        data.data && data.data[2].result
            ...
            : BigInt(0);
    const healthFactor = Number(rayhfactor / (RAY / BigInt(10 ** 2))) / 100;

    return (
        <div className="border rounded-lg grid grid-cols-1 md:grid-cols-3 divide-y md:divide-x md:divide-y-0">
            <div className="p-4 flex justify-between items-center">
                <div>
                    <p className="text-muted-foreground text-lg flex items-center space-x-2 md:space-x-1 lg:space-x-2">
